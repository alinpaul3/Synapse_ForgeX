...
class SchemaValidator:
    """Validates tabular or nested record structures."""
    ...
    ALLOWED_PLATFORMS = {"reddit", "youtube"}
    ...
    def __init__(
        ...
        Args:
            required_columns: Required column names for DataFrame validation
            column_types: Expected column types for DataFrame validation
            min_rows: Minimum number of rows required in tabular data
        """
    ...
    def validate_record(self, record: Dict[str, Any]) -> List[str]:
        ...
        if not isinstance(metadata, dict):
            ...
            for key in self.REQUIRED_METADATA_KEYS:
                ...
                elif not isinstance(metadata[key], (int, float)):
    ...
    def _validate_dataframe(self, df: Any) -> bool:
        """
        Validate a DataFrame-like object.
    ...
    @staticmethod
    def _type_matches(actual_type: Any, expected_type: str) -> bool:
